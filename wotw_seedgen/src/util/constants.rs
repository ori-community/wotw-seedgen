...
pub const SPAWN_GRANTS: &[(&str, Item)] = &[(
    ...
    Item::Teleporter(Teleporter::EastLuma),
)];
...
pub const SLUGSTRINGS: &[&[&str]] = &[
    ...
    &[
        "Grom", "Motay", "Veral", "Tuley", "Baur", "Shriek", "Ku", "Mokk", "Mantis", "Hornbug",
        "Skeeto", "Kii", "Miner", "Tokk", "Lupo", "Mora", "Howl", "Bear", "Light", "Gorlek",
        "Opher", "Lupo", "Kwolok", "Moki", "Worm", "Owl", "Gumo", "Naru", "Spirit", "Wolf",
        "Twillen", "Seir",
    ],
];
