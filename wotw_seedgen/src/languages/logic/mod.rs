...
pub fn parse_logic(areas: &str, locations: &str, states: &str, game_settings: &GameSettings, validate: bool) -> Result<Graph, String> {
    ...
    build(areas, locations, &named_states, game_settings, validate)
}
