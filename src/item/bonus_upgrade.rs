...
impl BonusUpgrade {
    ...
    pub fn icon(self) -> Option<Icon> {
        match self {
            BonusUpgrade::RapidHammer => Some(Icon::File(String::from("assets/icons/rapidsmash.png"))),
            BonusUpgrade::RapidSword => Some(Icon::File(String::from("assets/icons/rapidsword.png"))),
            BonusUpgrade::BlazeEfficiency => Some(Icon::File(String::from("assets/icons/blazeefficiency.png"))),
            BonusUpgrade::SpearEfficiency => Some(Icon::File(String::from("assets/icons/spearefficiency.png"))),
            BonusUpgrade::ShurikenEfficiency => Some(Icon::File(String::from("assets/icons/shurikenefficiency.png"))),
            BonusUpgrade::SentryEfficiency => Some(Icon::File(String::from("assets/icons/sentryefficiency.png"))),
            BonusUpgrade::BowEfficiency => Some(Icon::File(String::from("assets/icons/bowefficiency.png"))),
            BonusUpgrade::RegenerationEfficiency => Some(Icon::File(String::from("assets/icons/regenerationefficiency.png"))),
            BonusUpgrade::FlashEfficiency => Some(Icon::File(String::from("assets/icons/flashefficiency.png"))),
            BonusUpgrade::GrenadeEfficiency => Some(Icon::File(String::from("assets/icons/grenadeefficiency.png"))),
