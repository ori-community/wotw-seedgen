...
pub struct WorldPresetSettings {
    ...
    /// Logically expected tricks you may have to use
    ///
    /// Available tricks are "swordsentryjump", "hammersentryjump", "shurikenbreak", "sentrybreak", "hammerbreak", "spearbreak", "sentryburn", "removekillplane", "launchswap", "sentryswap", "flashswap", "blazeswap", "wavedash", "grenadejump", "hammerjump", "swordjump", "grenaderedirect", "sentryredirect", "pausefloat", "glidejump", "glidehammerjump", "spearjump", "glidebashchain", "doublejumpbashchain", "dashbashchain", "launchbashchain", "unpopular"
    #[structopt(short, long)]
