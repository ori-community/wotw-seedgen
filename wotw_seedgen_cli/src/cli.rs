...
pub struct SeedSettings {
    ...
    ///
    /// Available tricks are "swordsentryjump", "hammersentryjump", "shurikenbreak", "sentrybreak", "hammerbreak", "spearbreak", "sentryburn", "removekillplane", "launchswap", "sentryswap", "flashswap", "blazeswap", "wavedash", "grenadejump", "swordjump", "grenaderedirect", "sentryredirect", "pausefloat", "glidejump", "aerialhammerjump", "glidehammerjump", "coyotehammerjump", "wallhammerjump", "groundedhammerjump", "hammerextension", "spearjump", "glidebashchain", "doublejumpbashchain", "dashbashchain", "launchbashchain", "unpopular"
    #[structopt(short, long)]
...
pub struct WorldPresetSettings {
    ...
    /// Logically expected tricks you may have to use
    ///
    /// Available tricks are "swordsentryjump", "hammersentryjump", "shurikenbreak", "sentrybreak", "hammerbreak", "spearbreak", "sentryburn", "removekillplane", "launchswap", "sentryswap", "flashswap", "blazeswap", "wavedash", "grenadejump", "swordjump", "grenaderedirect", "sentryredirect", "pausefloat", "glidejump", "glidehammerjump", "spearjump", "glidebashchain", "doublejumpbashchain", "dashbashchain", "launchbashchain", "unpopular"
    #[structopt(short, long)]
